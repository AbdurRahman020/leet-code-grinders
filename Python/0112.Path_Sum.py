...
if __name__ == '__main__':
    ...
    print(s.hasPathSum1(TreeNode(5, TreeNode(4, TreeNode(11, TreeNode(7), TreeNode(2))), TreeNode(8, TreeNode(13), TreeNode(4, None, TreeNode(1)))), 22))
    print(s.hasPathSum1(TreeNode(1, TreeNode(2), TreeNode(3)), 5))
    print(s.hasPathSum1(TreeNode(), 0))
    
    print(s.hasPathSum2(TreeNode(5, TreeNode(4, TreeNode(11, TreeNode(7), TreeNode(2))), TreeNode(8, TreeNode(13), TreeNode(4, None, TreeNode(1)))), 22))
