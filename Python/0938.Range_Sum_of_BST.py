...
if __name__ == '__main__':
    ...
    r1 = TreeNode(10, TreeNode(5, TreeNode(3), TreeNode(7)),
                  TreeNode(15, None, TreeNode(18)))
    print(s.rangeSumBST(r1, 7, 15))

    r2 = TreeNode(10, TreeNode(5, TreeNode(3, TreeNode(1)), TreeNode(
        7, None, TreeNode(6))), TreeNode(15, TreeNode(13), TreeNode(18)))
