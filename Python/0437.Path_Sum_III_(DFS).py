...
if __name__ == '__main__':
    s = Solution()
    r1 = TreeNode(10, TreeNode(5, TreeNode(3, TreeNode(3), TreeNode(-2)),
                  TreeNode(2, None, TreeNode(1))), TreeNode(-3, None, TreeNode(11)))
    print(s.pathSum(r1, 8))
    r2 = TreeNode(5, TreeNode(4, TreeNode(11, TreeNode(7), TreeNode(2))), TreeNode(
