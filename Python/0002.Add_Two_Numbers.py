...
class Solution:
    def addTwoNumbers(self, l1: ListNode, l2: ListNode) -> ListNode:
        ...
        # traverse both linked lists simultaneously until either of them or
        # carry is not None
        while l1 or l2 or carry:
            ...
            # update carry by dividing the sum by 10 (to get the carry) and
            # update the sum by taking its remainder when divided by 10
            carry = val//10
            val = val % 10
