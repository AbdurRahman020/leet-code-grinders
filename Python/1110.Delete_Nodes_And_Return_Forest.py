...
if __name__ == '__main__':
    ...
    print([i.serialize() for i in s.delNodes1(r1, [3, 5])])
    r2 = TreeNode(1, TreeNode(2), TreeNode(4, TreeNode(3)))
    print([i.serialize() for i in s.delNodes1(r2, [3])])
    
    r1 = TreeNode(1, TreeNode(2, TreeNode(4), TreeNode(5)), TreeNode(3, TreeNode(6), TreeNode(7)))
    print([i.serialize() for i in s.delNodes2(r1, [3, 5])])
    r2 = TreeNode(1, TreeNode(2), TreeNode(4, TreeNode(3)))
    print([i.serialize() for i in s.delNodes2(r2, [3])])