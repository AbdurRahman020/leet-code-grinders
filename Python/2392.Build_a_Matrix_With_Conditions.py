...
class Solution:
    ...
    def buildMatrix2(self, k: int, rowConditions: List[List[int]], colConditions: List[List[int]]) -> List[List[int]]:
        # function for topological sort
...
if __name__ == '__main__':
    ...
    print(s.buildMatrix1(3, [[1,2],[3,2]], [[2,1],[3,2]]))
    print(s.buildMatrix1(3, [[1,2],[2,3],[3,1],[2,3]], [[2,1]]))
    
    print(s.buildMatrix2(3, [[1,2],[3,2]], [[2,1],[3,2]]))
    print(s.buildMatrix2(3, [[1,2],[2,3],[3,1],[2,3]], [[2,1]]))
