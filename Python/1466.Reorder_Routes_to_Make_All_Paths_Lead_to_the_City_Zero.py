...
if __name__ == '__main__':
    ...
    print(s.minReorder1(5, [[1,0],[1,2],[3,2],[3,4]]))
    print(s.minReorder1(3, [[1,0],[2,0]]))
    
    print(s.minReorder2(6, [[0,1],[1,3],[2,3],[4,0],[4,5]]))
    print(s.minReorder2(5, [[1,0],[1,2],[3,2],[3,4]]))
    print(s.minReorder2(3, [[1,0],[2,0]]))
