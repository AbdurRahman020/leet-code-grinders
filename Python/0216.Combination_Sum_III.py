...
if __name__ == '__main__':
    ...
    print(s.combinationSum3_1(3, 7))
    print(s.combinationSum3_1(3, 9))
    print(s.combinationSum3_1(4, 1))
    
    print(s.combinationSum3_2(3, 7))
    print(s.combinationSum3_2(3, 9))
    print(s.combinationSum3_2(4, 1))